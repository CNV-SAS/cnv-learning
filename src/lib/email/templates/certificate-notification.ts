...
//
// Issued: subject "Tu certificado de {course} esta listo" + CTAs
// "Descargar PDF" y "Ver verificacion publica".
//
// Revoked: subject "Tu certificado de {course} fue revocado" +
// motivo + CTA "Ver verificacion publica" (que muestra el estado
// revocado al verificador).
//
...
function buildIssued(params: IssuedParams): CertificateNotificationEmail {
  const subject = `Tu certificado de ${params.courseTitle} está listo`;
...
<body style="margin:0; padding:0; background-color:#ffffff; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif; color:#0f172a;">
  <div style="max-width: 600px; margin: 0 auto; padding: 32px 24px;">
    ...
    <h1 style="font-size: 24px; font-weight: 700; margin: 0 0 16px 0; color: #0f172a;">Tu certificado está listo</h1>
    <p style="font-size: 14px; margin: 0 0 24px 0; color: #64748b;">
      Hola ${escapeHtml(params.studentName)}, completaste el curso y recibiste tu certificado de finalización.
    </p>
    ...
    <p style="margin: 0 0 16px 0;">
      <a href="${params.pdfUrl}" style="display: inline-block; background-color: #059669; color: #ffffff; text-decoration: none; padding: 12px 24px; border-radius: 8px; font-size: 14px; font-weight: 600;">Descargar certificado (PDF)</a>
    </p>
  ...
  const text = [
    ...
    ``,
    `Completaste el curso "${params.courseTitle}" y recibiste tu certificado de finalización.`,
    ``,
...
function buildRevoked(
  ...
  const subject = `Tu certificado de ${params.courseTitle} fue revocado`;
...
<body style="margin:0; padding:0; background-color:#ffffff; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif; color:#0f172a;">
  <div style="max-width: 600px; margin: 0 auto; padding: 32px 24px;">
    ...
    <h1 style="font-size: 24px; font-weight: 700; margin: 0 0 16px 0; color: #0f172a;">Tu certificado fue revocado</h1>
    <p style="font-size: 14px; margin: 0 0 24px 0; color: #64748b;">
      Hola ${escapeHtml(params.studentName)}, te informamos que el certificado correspondiente al curso indicado fue revocado.
    </p>
  ...
  const text = [
    `Hola ${params.studentName},`,
    ``,
    `Te informamos que el certificado correspondiente al curso "${params.courseTitle}" fue revocado.`,
    ``,
