...
import { updateAssignmentSchema } from "@/modules/courses/validations";
...
export async function updateAssignmentAction(
  ...
  try {
    return await withContext({ requestId }, async () => {
      ...
      const result = await courseContentEditorService.updateAssignment({
        user,
    ...
    logger.error("updateAssignmentAction unexpected throw", {
