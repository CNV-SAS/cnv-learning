...
import { updateLessonSchema } from "@/modules/courses/validations";
...
export async function updateLessonAction(
  ...
  try {
    return await withContext({ requestId }, async () => {
      ...
      const result = await courseContentEditorService.updateLesson({
        user,
    ...
    logger.error("updateLessonAction unexpected throw", {
